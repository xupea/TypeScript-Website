 ...
 */
export declare const getReferencesForModule: (ts: typeof import("typescript"), code: string) => {
    module: string;
    version: string | undefined;
}[];
/** A list of modules from the current sourcefile which we don't have existing files for */
export declare function getNewDependencies(config: ATABootstrapConfig, moduleMap: Map<string, ModuleMeta>, code: string): {
    module: string;
    version: string | undefined;
}[];
/** The bulk load of the work in getting the filetree based on how people think about npm names and versions */
export declare const getFileTreeForModuleWithTag: (config: ATABootstrapConfig, moduleName: string, tag: string | undefined) => Promise<{
    moduleName: string;
    version: string;
    default: string;
    files: {
